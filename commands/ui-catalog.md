---
name: uc
description: ui-catalog 開発コマンド (project)
---

# uc — ui-catalog 開発コマンド
...
3. atoms/index.ts に Slider のエクスポートを追加 → /uc rf
```
...
💡 推奨アクション:
1. project/pleasync から 3件をマージ → /uc mg
2. 全 project/* に 1件を配布 → /uc ds
```
