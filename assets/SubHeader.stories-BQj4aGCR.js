import{j as e}from"./iframe-DWeAzsMr.js";import"./preload-helper-PPVm8Dsz.js";const p="_subHeader_ipnv4_1",i={subHeader:p};function s({topOffset:a,leftOffset:r=0,children:n,className:l,style:o,innerRef:d}){const c=[i.subHeader,l].filter(Boolean).join(" ");return e.jsx("div",{ref:d,className:c,style:{top:`${a}px`,left:`${r}px`,...o},"data-component":"SubHeader",children:n})}try{s.displayName="SubHeader",s.__docgenInfo={description:`汎用サブヘッダーコンポーネント
