import{j as e,R as d}from"./iframe-2z8Hl2jC.js";import{A as l}from"./AlertDialog-vgIPEWh_.js";import"./preload-helper-PPVm8Dsz.js";import"./Dialog-Lh6Kh60A.js";import"./index-ceUOm_iH.js";import"./index-DpVMA5hu.js";import"./Button-DuIKyBC0.js";import"./useOperationLog-0HvfpEDm.js";import"./Icon-DQoCPfk-.js";import"./cn-0exNfmSl.js";import"./clsx-B-dksMZM.js";import"./Spinner-CgsV25FN.js";import"./colors-BiHXYRGc.js";import"./Text-BNefPDJW.js";const E={title:"フィードバック/ダイアログ/AlertDialog",component:l,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:`
window.alertの代替として使用するアラートダイアログコンポーネント。
• 4種類のタイプ(info, warning, error, success)
• Escキーまたはエンターキーで閉じることが可能
• 背景クリックで閉じることが可能`}}},argTypes:{isOpen:{control:{type:"boolean"},description:"ダイアログの表示状態",table:{defaultValue:{summary:!1}}},type:{control:{type:"select"},options:["info","warning","error","success"],description:"アラートのタイプ",table:{defaultValue:{summary:"info"}}},title:{control:{type:"text"},description:"ダイアログのタイトル"},message:{control:{type:"text"},description:"アラートメッセージ"},confirmText:{control:{type:"text"},description:"確認ボタンのテキスト",table:{defaultValue:{summary:"OK"}}},onClose:{action:"closed",description:"閉じるときのハンドラ"}}},n={args:{isOpen:!0,type:"info",title:"情報",message:"これは情報メッセージです。",confirmText:"閉じる"},parameters:{docs:{description:{story:"情報を表示する標準的なアラート"}}}},o={args:{isOpen:!0,type:"warning",title:"警告",message:"この操作には注意が必要です。",confirmText:"了解"},parameters:{docs:{description:{story:"注意を促す警告アラート"}}}},t={args:{isOpen:!0,type:"error",title:"エラー",message:"エラーが発生しました。もう一度お試しください。",confirmText:"閉じる"},parameters:{docs:{description:{story:"エラーを通知するアラート"}}}},a={args:{isOpen:!0,type:"success",title:"成功",message:"操作が正常に完了しました。",confirmText:"閉じる"},parameters:{docs:{description:{story:"成功を通知するアラート"}}}},i={args:{isOpen:!0,type:"info",message:"タイトルなしのシンプルなアラートです。"},parameters:{docs:{description:{story:"タイトルを省略したシンプルなアラート"}}}},c={args:{isOpen:!0,type:"info",title:"お知らせ",message:`これは長いメッセージの例です。
