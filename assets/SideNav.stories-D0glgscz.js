import{j as e,r as m}from"./iframe-CAHZyj7a.js";import"./preload-helper-PPVm8Dsz.js";const g="_sideNav_1at6y_1",v="_sideNav__content_1at6y_7",o={sideNav:g,sideNav__content:v};function a({width:u,topOffset:t,isOpen:n=!0,bgColor:d,children:i,className:l,style:c}){const p=[o.sideNav,l].filter(Boolean).join(" ");return e.jsx("div",{className:p,style:{width:`${u}px`,top:`${t}px`,left:n?0:`-${u}px`,backgroundColor:d,...c},"data-component":"SideNav",children:e.jsx("div",{className:o.sideNav__content,children:i})})}try{a.displayName="SideNav",a.__docgenInfo={description:`汎用サイドナビコンポーネント
