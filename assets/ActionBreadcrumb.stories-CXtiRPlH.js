import{A as l}from"./ActionBreadcrumb-CQERqtln.js";import"./iframe-BwWmhw3u.js";import"./preload-helper-PPVm8Dsz.js";import"./useOperationLog-0HvfpEDm.js";const i={title:"ナビゲーション/パンくず/ActionBreadcrumb",component:l,tags:["autodocs"],parameters:{layout:"centered"}},e={args:{items:[{label:"ホーム",onClick:()=>{}},{label:"設定",onClick:()=>{}},{label:"詳細"}]}},a={args:{items:[{label:"トップ",onClick:()=>{}},{label:"カテゴリ",onClick:()=>{}},{label:"アイテム"}],separator:">"}},r={args:{items:[{label:"ダッシュボード"}]}},n={args:{items:[{label:"ホーム",onClick:()=>{}},{label:"管理",onClick:()=>{}},{label:"ユーザー",onClick:()=>{}},{label:"ロール設定",onClick:()=>{}},{label:"権限詳細"}],separator:"/"}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    items: [{
      label: 'ホーム',
      onClick: () => {}
