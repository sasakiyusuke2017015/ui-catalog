import{j as r}from"./iframe-CEBuvpRZ.js";import{E as o}from"./EmptyState-B4uAChSv.js";import"./preload-helper-PPVm8Dsz.js";const c={title:"フィードバック/EmptyState",component:o,tags:["autodocs"],parameters:{layout:"centered"}},t={args:{title:"データがありません",description:"新しいアイテムを追加してください。"}},e={args:{icon:r.jsx("span",{style:{fontSize:32},children:"📭"}),title:"メッセージはありません",description:"新しいメッセージが届くとここに表示されます。"}},s={args:{icon:r.jsx("span",{style:{fontSize:32},children:"📋"}),title:"項目がありません",description:"最初の項目を作成しましょう。",action:r.jsx("button",{className:"mt-2 rounded bg-blue-500 px-4 py-2 text-white hover:bg-blue-600",children:"新規作成"})}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    title: 'データがありません',
